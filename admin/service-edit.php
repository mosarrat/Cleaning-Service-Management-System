                    ...
                    <div class="card bg-light mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form action="service-update.php?ID=<?php echo $ID?>" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" class="form-control mb-2" placeholder=" Price Description" name="price_des" value="<?php echo $price_des?>">
                                ...
                                <a href ="manage-service.php" class="btn btn-danger">cancel</a>
