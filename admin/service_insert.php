<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            $query = " insert into service (Title,Description,Price,Price_des,Image_Name,Category_Title,Active) values('$service_title','$discription','$price','$price_des','$image_name','$category_title','$active')";
